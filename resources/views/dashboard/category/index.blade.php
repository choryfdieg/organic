...
<a href="{{ route('category.create') }}" class="btn btn-primary mt-3 mb-3">Crear Categoria</a>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" data-id="{{$category->id}}">Eliminar</button>
        </tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <form action="" data-action="{{route('category.destroy', 0)}}" id="formDelete" method="POST">
                @method('DELETE')
                @csrf
...
<script>
    window.onload = function(){
        $('#exampleModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
            modal.find('#modalLabel').text('Vas a borrar la CATEGORIA: ' + id);
